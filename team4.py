...
team_name = 'Nom_Prince' # Only 10 chars displayed.
strategy_name = 'Tit for tat with history'
strategy_description = 'Beginning with tit for tat strategy but also put parameters with certain history scenarios'
